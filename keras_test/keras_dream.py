...
print(model.layers[1].weights[0].get_value().shape)
print('Model loaded.')
...
#     print(name, layer)
print("Layer count: ", len(layer_dict))

bad_layers_names = set(settings['features'].keys()) - set(layer_dict.keys())
for layer_name in bad_layers_names :
...
for layer_name in settings['features']:
    ...
    print("LLL", layer_name, coeff, K.shape(x), loss, scaling)
    if K.image_data_format() == 'channels_first':
